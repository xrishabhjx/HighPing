  ...
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000000,#0A0921_34%,#131243_65%,#1D1B64_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          <a href="#" className="inline-flex gap-3 border py-1 px-2 rounded-lg border-white/30">
            ...
            <span className='inline-flex items-center gap-1'>
              <span className='hover:text-purple-300 transition'><a href="https://github.com/HarshS16/Verifact/blob/main/README.md">Read More</a></span>
              <ArrowWIcon />
            </span>
          </a>
        </div>
        ...
        <div className='flex justify-center mt-8'>
          <a href="https://verifact-high-ping.streamlit.app/" rel="noopener noreferrer">
            <button className='bg-white text-black py-3 px-5 rounded-lg font-medium hover:bg-gray-200 transition'>
              Check News
            </button>
          </a>
        </div>
